...
// we encapsulates the particular hash value implementation
...
impl Block {
    // Create a brand new block. The hash value will be calculated and set
    // automatically.
    ...
    pub fn calculate_hash(&self) -> BlockHash {
        // we can't use the hash field to calculate the hash
        ...
        // Calculate and return the SHA-256 value for the block
