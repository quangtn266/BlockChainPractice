...
// we export functions to workaround constanst value restrictions in Rust
#[cfg(test)]
pub mod test_util {
...
mod tests {
    ...
    fn parse_case_insensitive() {
        let hext_str = "F780B958227ff0bf5795ede8f9f7eaac67e7e06666b043a400026cbd421ce28e".to_string();
        let address = Address::try_from(hext_str.clone()).unwrap();
        assert_eq!(address.to_string(), hext_str.to_lowercase());
    }

    #[test]
    fn parse_json() {
        let hex_str = "f780b958227ff0bf5795ede8f9f7eaac67e7e06666b043a400026cbd421ce28e".to_string();
        let address: Address = serde_json::from_value(serde_json::Value::String(hex_str.clone())).unwrap();
